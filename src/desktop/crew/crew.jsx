...
const Crew = () => {
  ...
  return (
    <>
      ...
      >
        <Header />
        <div className="flex flex-col sm:flex-col-reverse lg:flex-row-reverse justify-evenly lg:h-8/12">
          <div className="flex flex-col lg:justify-end  mx-auto lg:mx-0 w-96 h-80 lg:h-4/5 lg:w-1/3 mt-60 sm:mt-16 lg:mt-14 border-b-2  border-faded sm:border-none ">
            <img
              className="w-96 h-80 sm:w-w-tab sm:h-h-tab lg:h-11/12 lg:w-4/5 lg: object-contain transition-opacity block mx-auto"
              src={images[renderId]}
              alt="crew pictures"
            />
          </div>

          <div className="flex flex-col-reverse sm:flex-col items-center justify-center lg:block lg:w-5/12 mt-24 lg:ml-16 lg:mt-40 ">
            ...
            <div className="lg:h-12 w-40 lg:w-56 flex justify-evenly align-middle -mt-12 sm:-mt-16 lg:mt-1 mx-auto lg:ml-24 lg:float-left ">
              <div
