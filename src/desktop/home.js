        ...
        <>
            ...
            >
                ...
                <div className="flex justify-between relative ">
                    ...
                    <div className=" w-96 h-80  absolute top-80 left-32" >
                        ...
                        <p className="text-xl font-barC w-60 text-white text-justify mx-auto">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back,
                            and relax because we’ll give you a truly out of this world experience!</p>
                    </div>
                    <div className=" w-96 h-96 bg-transparent absolute top-80 right-32 flex justify-center items-center rounded-full hover:bg-backg">
